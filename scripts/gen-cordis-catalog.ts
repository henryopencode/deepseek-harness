...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SpeechToTextDescription: 'speech.md',
  SpeechToTextModel: 'speech.md',
  SpeechToTextModelPreference: 'speech.md',
  SpeechTranscriptionFailure: 'speech.md',
  SpeechTranscriptionRequest: 'speech.md',
  SpeechTranscriptionResult: 'speech.md',
